        ...
        <div name="about" className='w-full h-auto bg-gradient-to-b from-gray-800 to-black text-white'>
            <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-auto'>
                ...
                <p data-aos="slide-up" data-aos-duration="500" className='text-xl mt-5 ease-in fade-in'>
                    I embarked my journey as a B.Tech Computer Science & Engineering with specialization course DATA SCIENCE ,student at Jodhpur Institute of Design And Technology, Jodhpur in 2021. Along the way, I fearlessly explored various fields, including DSA, Database Management System(DBMS), MERN Stack, and BACKEND DEVELOPMENT. I delved into the world of cutting-edge technologies, such as C,C++,Python,HTML,Java script, and ExpressJs.
                </p>
                <br />
                <p data-aos="slide-up" data-aos-duration="500" className='text-xl mt-5 ease-in fade-in'>
                    In a constant pursuit of sharing knowledge and fostering growth, I've organized numerous technical Classes for friends, imparting valuable insights on technologies like C++, java script,etc to aspiring learners. With a commitment to personal development and a drive for making a positive impact within the tech community.
                </p>
                {/* <br />
                ...
                <div data-aos="zoom-in" data-aos-duration="500" className='mb-20 fade-in flex mx-auto items-center justify-center hover:scale-105 duration-300 rounded bg-gradient-to-b from-cyan-500 to-blue-500 lg:w-1/5 md:w-1/5 w-2/4 h-10 text-center cursor-pointer mt-10 gap-2'>
                    ...
                    <a href="https://drive.google.com/file/d/1mBf46FUfOhYVLnW27aYGo5fe9Zc_tZWd/view?usp=drivesdk" download>RESUME</a>
                </div>
            </div>
        </div>
    )
